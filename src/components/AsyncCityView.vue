<template>
    <div class="flex flex-col flex-1 items-center">
      ...
      >
        <p>
          Şu anda bu şehri önizliyorsunuz, şehri takip etmeye başlamak için "+" simgesine tıklayın.
        </p>
      </div>
      <!-- Weather Overview -->
      ...
      <div class="max-w-screen-md w-full py-12">
        <div class="mx-8 text-white">
          <h2 class="mb-4">Saatlik Hava Durumu</h2>
      ...
      <div class="max-w-screen-md w-full py-12">
        <div class="mx-8 text-white">
          <h2 class="mb-4">7 Günlük Tahmin</h2>
          <div
